...
/// Workout Mode Selection Page - Step 1
/// Matches HTML reference: 02-guide-step1.html
...
class _WorkoutGuideStep1PageState extends State<WorkoutGuideStep1Page> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<WorkoutGuideProvider>().initializeStep1();
    });
  }
            ...
            children: [
              Expanded(
                child: _buildModeCard(
                  ...
                  imageUrl: 'assets/images/water_bottle_workout.jpg',
                ),
              ),
              const SizedBox(width: 16),
              Expanded(
                child: _buildModeCard(
                  ...
                  imageUrl: 'assets/images/chair_workout.jpg',
                ),
              ),
            ],
          ),
